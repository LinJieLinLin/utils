...
const setLog = (logLevel = 4, logConfig = { error: 0 }) => {
    ...
    for (let key in logConfig) {
        if (console[key]) {
            console[key] = (...arg) => {
                var _a;
                const line = ((_a = safeData(Error(), 'stack', [])) === null || _a === void 0 ? void 0 : _a.split('\n')[2]) || '';
...
const on = (function () {
    var _a;
    if (typeof ((_a = globalThis.document) === null || _a === void 0 ? void 0 : _a.addEventListener) === 'function') {
...
const off = (function () {
    var _a;
    if (typeof ((_a = globalThis.document) === null || _a === void 0 ? void 0 : _a.removeEventListener) === 'function') {
        return function (el, event, handler) {
            if (el && event) {
