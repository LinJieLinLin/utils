 ...
 * @function
 * @description 扫一扫回调
 * 样例数据：{"type":"marked","timeStamp":1635131673066,"target":{"id":"1","dataset":{},"offsetLeft":0,"offsetTop":0},"currentTarget":{"id":"1","dataset":{},"offsetLeft":0,"offsetTop":0},"detail":{"code":0,"type":"success","message":"https://baidu.com","charSet":"ISO8859_1"}}
 */
window.SCAN_CB = function (argData) {
  var data = JSON.parse(argData)
  alert(data.type)
  // todo
}
